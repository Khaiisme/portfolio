const socialLinks = [
  {
    href: "https://github.com/Khaiisme",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  return (
    <section id="contact" className="py-16 bg-zinc-900 text-white">
      <div className="container mx-1 grid grid-cols-1 md:grid-cols-2 gap-0 px-4 items-center">
        ...
        <form
          action="https://getform.io/f/bjjjqglb"
          method="POST"
          className="space-y-1 bg-zinc-800 p-5 rounded-lg shadow-lg"
        >
        <h2 className="text-center text-lg select-none font-bold"> Send me an Email</h2>
          <div className="form-group">
            ...
            <input
              type="text"
              className="w-full p-3 mt-2 rounded-md bg-gray-700 text-white placeholder-gray-400  focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="form-group">
            ...
            <textarea
              className="w-full p-4 mt-2 rounded-md bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              name="message"
              rows="4"
          ...
          <button
            type="submit"
            className="w-full py-3 mt-4 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-800 transition duration-300"
          >
            Submit
          </button>
        </form>
